                            ...
                            <div class="py-3 d-flex flex-row align-items-l justify-content-left">
                                ...
                                <form  method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name"  class="form-control" id="exampleFormControlInput1" placeholder="Imię i nazwisko">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleFormControlInput1">Email użytkownika</label>
                                        <input type="email" name="email"   class="form-control" id="exampleFormControlInput2" placeholder="Email uzytkownika">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleFormControlInput1">Hasło użytkownika</label>
                                        <input type="password" name="password"    class="form-control" id="exampleFormControlInput3" placeholder="Hasło użytkownika">
                                        <br>
