...
<%--                                                wstawiam linki które odsyłają do odpowiednich servletów USUN,EDYTUJ I POKAZ--%>
                                                <c:url value="/user/delete?userId=${user.id}" var="deleteURL"/>
                                                <a href=${deleteURL}> Usuń </a>

                                                <c:url value="/user/edit?userId=${user.id}" var="editURL"/>
                                                <a href=${editURL}> Edytuj </a>

                                                <c:url value="/user/show?userId=${user.id}" var="showURL"/>
                                                <a href=${showURL}> Pokaż </a>
