                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-7">
                        <div class="card shadow mb-4">
                            ...
                            <div class="py-5 px-1 d-flex flex-column align-items-left justify-content-left">
                                <form method="get">
                                    <table border=1 frame=void rules=rows width="100%"  >
                                        <tr>
                                            <th>ID</th>
                                            <td style="text-align:left"><h6 class="m-0 font-weight-bold text-primary">${userId}</h6></td>
                                        </tr>
                                        <tr>
                                            <th>Nazwa użytkownika</th>
                                            <td><h6 class="m-0 font-weight-bold text-primary">${userName}</h6></td>
                                        </tr>
                                        <tr>
                                            <th>Email</th>
                                            <td><h6 class="m-0 font-weight-bold text-primary">${userEmail}</h6></td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
