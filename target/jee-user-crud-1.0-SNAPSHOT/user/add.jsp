...
<%------------------------------------------------------------------------------------------------------------------%>
                                <form  method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="userName"  class="form-control" id="userName" placeholder="Imię i nazwisko">
                                    </div>
                                    <div class="form-group">
                                        <label for="userEmail">Email użytkownika</label>
                                        <input type="email" name="userEmail"   class="form-control" id="userEmail" placeholder="Email uzytkownika">
                                    </div>
                                    <div class="form-group">
                                        <label for="userPassword">Hasło użytkownika</label>
                                        <input type="password" name="userPassword"    class="form-control" id="userPassword" placeholder="Hasło użytkownika">
                                        <br>
...
<%--&lt;%&ndash;<script src="SB%20Admin%202%20-%20Dashboard_files/jquery_002.js"></script>&ndash;%&gt;--%>
<%--<script src="/theme/vendor/bootstrap/js/bootstrap.js"></script>--%>
<%--&lt;%&ndash;<script src="SB%20Admin%202%20-%20Dashboard_files/bootstrap.js"></script>&ndash;%&gt;--%>

<%--<!-- Core plugin JavaScript-->--%>
<%--&lt;%&ndash;<script src="SB%20Admin%202%20-%20Dashboard_files/jquery.js"></script>&ndash;%&gt;--%>
